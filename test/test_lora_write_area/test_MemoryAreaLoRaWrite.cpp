#include "memory/MemoryAreas/src/MemoryAreaLoRaWrite.h"

#include "unity.h"
#include "freertos/FreeRTOS.h"
#include "freertos/task.h"

void test_MemoryAreaLoRaWrite() {
    auto result = ESP_FAIL;
    auto memory_area_instance = new MemoryAreaLoRaWrite;
    ...
    TEST_ASSERT_EQUAL(memory_area_instance->GetAreaIndex(), 4);
...
void main_test(void) {
    ...
    UNITY_BEGIN();
    RUN_TEST(test_MemoryAreaLoRaWrite);
    UNITY_END();
}
